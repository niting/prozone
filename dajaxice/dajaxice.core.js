...
var Dajaxice = {
    ...
    dataEverything: function(callback_function, argv, custom_settings){
        Dajaxice.call('gui.dataEverything', 'POST', callback_function, argv, custom_settings);
    },

    update_players: function(callback_function, argv, custom_settings){
        Dajaxice.call('gui.update_players', 'POST', callback_function, argv, custom_settings);
    }
